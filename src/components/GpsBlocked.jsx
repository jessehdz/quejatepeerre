...
function GpsBlocked({ onClose }) {
    ...
    return (
        <div className="gps-blocked-backdrop" onClick={onClose}>
            <div className="gps-blocked-sheet" onClick={e => e.stopPropagation()}>
                ...
                <button className="gps-blocked-close" onClick={onClose}>Entendido</button>
            </div>
        </div>
    );
}
